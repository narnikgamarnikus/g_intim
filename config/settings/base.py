"""
Base settings for g_intim project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'g_intim.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'g_intim.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'g_intim.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['g_intim.taskapp.celery.CeleryConfig']
